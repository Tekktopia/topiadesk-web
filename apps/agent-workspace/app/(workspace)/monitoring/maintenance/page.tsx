    ...
    <div className="space-y-5 p-5">
      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div className="space-y-1">
          ...
          <h1 className="font-display text-2xl font-bold tracking-tight">Maintenance Windows</h1>
          <p className="text-sm text-muted-foreground">Schedule downtime to suppress alerts during planned maintenance</p>
        </div>
        <Button size="sm"><Plus className="h-3 w-3" />New window</Button>
      </header>
