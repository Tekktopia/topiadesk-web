    ...
    <div className="space-y-5 p-5">
      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div className="space-y-1">
          ...
          <h1 className="font-display text-2xl font-bold tracking-tight">Down &amp; Problems</h1>
          <p className="text-sm text-muted-foreground">Everything currently offline, degraded, or triggering critical alerts</p>
        </div>
