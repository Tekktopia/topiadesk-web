    ...
    <div className="space-y-5 p-6">
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">Monitor threats, suspicious activity, and IP blocklist across all tenants.</p>
        </div>
        <Button variant="outline" size="sm" onClick={() => setShowBlocklist(!showBlocklist)}>
