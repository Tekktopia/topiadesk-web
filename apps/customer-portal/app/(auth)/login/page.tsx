...
export default function PortalLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(false);
    // In production: call auth API, redirect to /tickets
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Sign in to your support account to view and manage your tickets.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/reset" className="text-xs text-blue-600 hover:text-blue-700 hover:underline">
              Forgot password?
            </Link>
          </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Button variant="outline" className="text-sm" type="button">
          <svg viewBox="0 0 24 24" className="mr-2 h-4 w-4 fill-current" aria-hidden="true">
            <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.7 9.05 7.4c1.28.06 2.18.73 3.01.76 1.15-.22 2.25-.93 3.47-.84 1.47.12 2.58.69 3.32 1.76-3.07 1.84-2.35 5.87.52 7.02-.62 1.59-1.41 3.16-2.32 4.18zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
          </svg>
          Apple
        </Button>
      </div>
