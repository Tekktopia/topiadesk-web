  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center bg-background p-6 text-center">
      ...
      <p className="mt-2 max-w-xs text-sm text-muted-foreground leading-relaxed">
        Check your internet connection. You can still browse content you&apos;ve already loaded — any requests you submit will be sent when you&apos;re back online.
      </p>
